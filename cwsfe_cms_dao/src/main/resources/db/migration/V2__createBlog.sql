...
CREATE INDEX BLOG_POSTS_POST_AUTHOR_ID_INDEX
    ON BLOG_POSTS (post_author_id);
...
CREATE INDEX BLOG_POST_I18N_CONTENTS_POST_ID_INDEX
    ON BLOG_POST_I18N_CONTENTS (post_id);
CREATE INDEX BLOG_POST_I18N_CONTENTS_LANGUAGE_ID_INDEX
    ON BLOG_POST_I18N_CONTENTS (language_id);
...
CREATE INDEX BLOG_POST_IMAGES_POST_ID_INDEX
    ON BLOG_POSTS (id);
...
CREATE INDEX BLOG_POST_CODE_POST_ID_INDEX
    ON BLOG_POSTS (id);
...
CREATE INDEX CMS_BLOG_POST_COMMENTS_parent_comment_id_INDEX
    ON CMS_BLOG_POST_COMMENTS (parent_comment_id);
CREATE INDEX CMS_BLOG_POST_COMMENTS_blog_post_i18n_content_id_INDEX
    ON CMS_BLOG_POST_COMMENTS (blog_post_i18n_content_id);
