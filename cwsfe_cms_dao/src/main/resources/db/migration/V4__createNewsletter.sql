...
CREATE INDEX NEWSLETTER_MAIL_ADDRESSES_MAIL_GROUP_ID_INDEX
    ON NEWSLETTER_MAIL_ADDRESSES (MAIL_GROUP_ID);
CREATE INDEX NEWSLETTER_MAIL_ADDRESSES_CONFIRM_STRING_INDEX
    ON NEWSLETTER_MAIL_ADDRESSES (CONFIRM_STRING);
CREATE INDEX NEWSLETTER_MAIL_ADDRESSES_UN_SUBSCRIBE_STRING_INDEX
    ON NEWSLETTER_MAIL_ADDRESSES (UN_SUBSCRIBE_STRING);
