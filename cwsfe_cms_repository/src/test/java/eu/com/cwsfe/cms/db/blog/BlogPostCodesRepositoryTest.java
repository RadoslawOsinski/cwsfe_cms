...
//@Rollback
//@ContextConfiguration(classes = {RepositoriesTestsConfiguration.class, CmsAuthorsDAO.class, BlogPostsDAO.class, BlogPostCodesDAO.class})
//@IfProfileValue(name = "test-groups", values = {"integration-tests-local"})
//public class BlogPostCodesRepositoryTest extends AbstractTransactionalJUnit4SpringContextTests {
//
//    @Autowired
//    private BlogPostCodesRepository dao;
//
//    @Autowired
