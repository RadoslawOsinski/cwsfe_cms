...
<t:genericPage>
    <jsp:body>
        ...
        <div class="row">
            <div data-alert data-bind="visible: updateNewsletterTemplateAlerts.errorMessages().length > 0" class="alert-box radius alert">
            ...
            <div data-alert data-bind="visible: updateNewsletterTemplateAlerts.infoMessages().length > 0" class="alert-box radius success">
            ...
            <form id="editNewsletterTemplateForm" autocomplete="off">
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <input type="text" id="language" name="language" value="${newsletterTemplateLanguageCode}" required data-bind="textInput: newsletterTemplateViewModel.language"/>
                        <small class="invisible" data-bind="attr: { 'class': newsletterTemplateViewModel.languageIsRequiredStyle}">
                    ...
                    <div class="row">
                        ...
                        <input type="text" id="newsletterTemplateName" name="name"
                               maxlength="100"
                               value="${newsletterTemplate.name}" required data-bind="textInput: newsletterTemplateViewModel.newsletterTemplateName"/>
                        <small class="invisible" data-bind="attr: { 'class': newsletterTemplateViewModel.newsletterTemplateNameIsRequiredStyle}">
                    ...
                    <div class="row">
                        ...
                        <input type="text" id="newsletterTemplateSubject" name="subject"
                               maxlength="100"
                               value="${newsletterTemplate.subject}" required data-bind="textInput: newsletterTemplateViewModel.newsletterTemplateSubject"/>
                        <small class="invisible" data-bind="attr: { 'class': newsletterTemplateViewModel.newsletterTemplateSubjectIsRequiredStyle}">
                    ...
                    <div class="row">
                        <input type="button" id="updateNewsletterTemplate" class="button small radius primary"
                               value="<spring:message code="Save"/>" data-bind="enable: newsletterTemplateViewModel.updateNewsletterTemplateFormIsValid"/>
                        <input type="reset" id="resetNewsletterTemplate" value="Reset" class="button small radius alert">
                    </div>
                </fieldset>
            </form>
        </div>
        ...
        <div class="row">
            ...
            <div data-alert data-bind="visible: newsletterTemplateTestAlerts.errorMessages().length > 0" class="alert-box radius alert">
            ...
            <div data-alert data-bind="visible: newsletterTemplateTestAlerts.infoMessages().length > 0" class="alert-box radius success">
            ...
            <form id="newsletterTemplateTestSendForm">
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <input type="email" id="testEmail" maxlength="350" required data-bind="textInput: newsletterTemplateViewModel.testEmail"/>
                        <small class="invisible" data-bind="attr: { 'class': newsletterTemplateViewModel.testEmailIsRequiredStyle}">
                    ...
                    <div class="row">
                        <input type="button" id="newsletterTemplateTestSendButton" value="<spring:message code="TestSend"/>"
                               class="button small radius secondary" data-bind="enable: newsletterTemplateViewModel.newsletterTemplateTestSendFormIsValid">
                        <input type="reset" id="resetNewsletterTemplateTest" value="Reset" class="button small radius alert">
                    </div>
                </fieldset>
            </form>
        </div>
