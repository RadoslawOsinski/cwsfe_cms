...
<t:genericPage>
    <jsp:body>
        <div class="row">
            ...
            <div data-alert data-bind="visible: updateNewsletterMailAlerts.errorMessages().length > 0" class="alert-box radius alert">
            ...
            <div data-alert data-bind="visible: updateNewsletterMailAlerts.infoMessages().length > 0" class="alert-box radius success">
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <input type="text" id="recipientGroup"
                               value="${newsletterMailGroupName}" required data-bind="textInput: singleNewsletterMailViewModel.newsletterMailGroupName"/>
                        <small class="invisible" data-bind="attr: { 'class': singleNewsletterMailViewModel.newsletterMailGroupNameIsRequiredStyle}">
                    ...
                    <div class="row">
                        ...
                        <input type="text" id="newsletterName" name="name"
                               maxlength="100"
                               value="${newsletterMail.name}" required data-bind="textInput: singleNewsletterMailViewModel.name"/>
                        <small class="invisible" data-bind="attr: { 'class': singleNewsletterMailViewModel.nameIsRequiredStyle}">
                    ...
                    <div class="row">
                        ...
                        <input type="text" id="newsletterSubject" name="subject"
                               maxlength="100"
                               value="${newsletterMail.subject}" required data-bind="textInput: singleNewsletterMailViewModel.subject"/>
                        <small class="invisible" data-bind="attr: { 'class': singleNewsletterMailViewModel.subjectIsRequiredStyle}">
                    ...
                    <div class="row">
                        <input type="submit" name="requestHandler" value="<spring:message code="Save"/>"
                               class="button small radius primary" data-bind="enable: singleNewsletterMailViewModel.updateNewsletterMailFormIsValid"/>
                        <input type="button" id="confirmSendButton" value="<spring:message code="Send"/>"
                               class="button small radius secondary"/>
                        <input type="reset" id="resetUpdateNewsletterMail" value="Reset" class="button small radius alert">
                    </div>
                </fieldset>
            </form>
        </div>
        ...
        <div class="row">
            ...
            <div data-alert data-bind="visible: newsletterTestSendAlerts.errorMessages().length > 0" class="alert-box radius alert">
            ...
            <div data-alert data-bind="visible: newsletterTestSendAlerts.infoMessages().length > 0" class="alert-box radius success">
            ...
            <form id="newsletterTestSendForm">
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <input type="email" id="testEmail" maxlength="350" required data-bind="textInput: singleNewsletterMailViewModel.testEmail"/>
                        <small class="invisible" data-bind="attr: { 'class': singleNewsletterMailViewModel.testEmailIsRequiredStyle}">
                    ...
                    <div class="row">
                        ...
                        <input type="reset" id="resetNewsletterTestSend" value="Reset" class="button small radius alert">
                    </div>
                </fieldset>
            </form>
        </div>
