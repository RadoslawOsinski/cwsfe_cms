...
//@ContextConfiguration(classes = {AWSClientInitializer.class, IntegrationTestsDataSource.class, AWSBucketImageStorageService.class, CmsGlobalParamsRepository.class})
...
//        CmsGlobalParamsEntity rootBucket = cmsGlobalParamsDAO.getByCode("AWS_CWSFE_CMS_S3_ROOT_BUCKET_NAME");
...
//        CmsNewsImagesEntity cmsNewsImage = new CmsNewsImagesEntity();
...
//        //then
//        CmsGlobalParamsEntity rootBucket = cmsGlobalParamsDAO.getByCode("AWS_CWSFE_CMS_S3_ROOT_BUCKET_NAME");
//        CmsGlobalParamsEntity newsImagesPath = cmsGlobalParamsDAO.getByCode("CWSFE_CMS_S3_NEWS_IMAGES_PATH");
...
//        MultipartFile multipartFile = new MockMultipartFile("file",
//            file.getName(), "image/png", IOUtils.toByteArray(input));
//        BlogPostImagesEntity blogPostImage = new BlogPostImagesEntity();
...
//        //then
//        CmsGlobalParamsEntity rootBucket = cmsGlobalParamsDAO.getByCode("AWS_CWSFE_CMS_S3_ROOT_BUCKET_NAME");
//        CmsGlobalParamsEntity blogImagesPath = cmsGlobalParamsDAO.getByCode("CWSFE_CMS_S3_BLOG_IMAGES_PATH");
//        boolean fileUploaded = true;
//        try {
