package eu.com.cwsfe.cms.services;
...
public class BlogKeywordsService {
    ...
    @Autowired
    public void setBlogKeywordsRepository(BlogKeywordsRepository blogKeywordsRepository) {
        this.blogKeywordsRepository = blogKeywordsRepository;
    }

    public List<BlogKeywordsEntity> list() {
        return blogKeywordsRepository.list();
    }
}
