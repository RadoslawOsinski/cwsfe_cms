...
//
//    @Autowired
//    public BlogPostCommentsRestController(BlogPostCommentsRepository blogPostCommentsRepository) {
...
//        result.put("count", blogPostCommentsRepository.countCommentsForPostI18n(blogPostI18nContentId));
//        return result;
//    }
//
...
//        @ModelAttribute(value = "blogPostComment") BlogPostCommentDTO blogPostComment,
